    ...
    return (
        <div className='manager_bg_color'>
            ...
            <div className="manager-container">
                <div className="manager-header d-flex justify-content-between">
                    <h2>Manager</h2>
                ...
                <div className=''>
                    <div className='table-responsive w-100'>
                        <table className='table table-mana'>
                            <thead>
                                <tr className=''>
                                    <th>Name</th>
                                    <th>Surname</th>
                    ...
                    <Modal.Body>
                        <form onSubmit={handleSubmit(onSubmit)} className='w-100 mx-auto p-4 round fw-bold form_bg'>
                            <div className="p-field">
                                <InputText className='input-form' placeholder='Name' {...register('name', { required: 'Name is required' })} />
                                {errors.name && <span className='text-danger'>{errors.name.message}</span>}
                            </div>

                            <div className="p-field">
                                <InputText className='input-form' placeholder='Surname' {...register('surname', { required: 'Surname is required' })} />
                                {errors.surname && <span className='text-danger'>{errors.surname.message}</span>}
                            </div>

                            <div className="p-field">
                                <InputText className='input-form' placeholder='Mobile Number' type='number' {...register('mobileNo', { required: 'Mobile Number is required' })} />
                                {errors.mobileNo && <span className='text-danger'>{errors.mobileNo.message}</span>}
                            </div>

                            <div className="p-field">
                                <InputText className='input-form' placeholder='Email' {...register('email', { required: 'Email is required' })} />
                            ...
                            <div className="p-field">
                                <InputText className='input-form' placeholder='Projects' type='number' {...register('projects', { required: 'Projects is required' })} />
                                {errors.projects && <span className='text-danger'>{errors.projects.message}</span>}
                            </div>

                            <div className="p-field">
                                <InputText className='input-form' placeholder='Address' {...register('address', { required: 'Address is required' })} />
