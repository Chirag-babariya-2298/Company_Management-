    ...
    return (
        <div className="client_bg_color">
            ...
            <div className="client-container">
                <div className="client-header d-flex justify-content-between">
                    <h2>Clients</h2>
                            ...
                            {data && data.length > 0 ? (
                                data.map((element) => (
                                    <tr key={element._id}>
                                        ...
                                        <td>
                                            <Button variant="info" onClick={() => openModal(element)}><FaEdit /></Button>
                                            <Button variant="danger" onClick={() => handleDelete(element._id)} className="ms-2"><FaTrash /></Button>
                                        </td>
                                    </tr>
                                ))
                            ) : (
